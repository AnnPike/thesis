...
fig.legend([l1, l2], labels=line_labels, bbox_to_anchor=(0.8, 0.7))
plt.suptitle(f'M prod LSQR, A shape is {m}, {p}, 2')
plt.tight_layout()
plt.savefig(path_to_save+f'eigenvalues_experiment_LSQR')
plt.show()
